...
/**
     ...
     */
     ...
     //A 2D array with edges and vertices to be genarated
        ...
        try {
            generator.generateData("data/DATA3/data_"+EV[i][0]+"_"+EV[i][1]+".txt");
        } catch (IOException e) {
...

        {
            ...
            try
            {   	
                FileReader fin = new FileReader("data/DATA3/data_"+EV[i][0]+"_"+EV[i][1]+".txt");
      ...
      // above line adds the necessry data needed to the final DATA file
               ...
               try {
                  ...
                  ProcessBuilder pb = new ProcessBuilder("python3", "src/main/PLOTS.py");
